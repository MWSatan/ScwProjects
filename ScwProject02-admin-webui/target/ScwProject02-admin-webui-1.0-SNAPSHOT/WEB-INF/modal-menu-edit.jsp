    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-signin" role="form">
                    <div class="form-group has-success has-feedback">
                        <input type="hidden" value="" id="editMenuId">
                        请输入节点名称：<input type="text" id="editMenuName"   name="name" /><br />
                        请输入URL地址：<input type="text" id="editMenuUrl"  name="url" /><br />
            ...
            <div class="modal-footer">
                <button id="editMenuBtn" type="button" class="btn btn-primary">修改</button>
