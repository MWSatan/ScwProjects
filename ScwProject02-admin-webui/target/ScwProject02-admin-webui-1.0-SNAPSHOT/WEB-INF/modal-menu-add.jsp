<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<div id="addMenuModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-signin" role="form">
                    <div class="form-group has-success has-feedback">
                        <input type="hidden" value="" id="menuPid">
                        请输入节点名称：<input type="text" id="menuName"   name="name" /><br />
                        请输入URL地址：<input type="text" id="menuUrl"  name="url" /><br />
            ...
            <div class="modal-footer">
                <button id="saveMenuBtn" type="button" class="btn btn-primary">添加</button>
                <button id="resetBtn" type="reset" class="btn btn-refresh">重置</button>
