                                ...
                                <c:forEach items="${pageInfo.list}" var="admin" varStatus="mystatus">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="del(${admin.id},${pageInfo.pageNum},${pageInfo.pageNum},${param.keyword})" href="${pageContext.request.contextPath}/admin/remove/${admin.id}/${pageInfo.pageNum}/${param.keyword}.html"
