    ...
    function del(adminId, pageNum, keyword) {
        ...
        if (confirm("确定删除吗？")) {
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/admin/remove/" + adminId + "/" + pageNum + "/" + keyword + ".json",
                dataType: "json",
                                ...
                                <c:forEach items="${pageInfo.list}" var="admin" varStatus="mystatus">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="${pageContext.request.contextPath}/assign/to/assign/role/page.html?adminId=${admin.id}&pageNum=${pageInfo.pageNum}&keyword=${param.keyword}" class="btn btn-success btn-xs"><i
                                                    class="  glyphicon glyphicon-check"></i></a>


                                            <a href="${pageContext.request.contextPath}/admin/to/edit/page.html?adminId=${admin.id}&pageNum=${pageInfo.pageNum}&keyword=${param.keyword}" class="btn btn-primary btn-xs"><i
